...
public class Gatherer_3 extends BaseAdvancement implements ParentGrantedVisibility {
    ...
    public Gatherer_3(Advancement parent) {
        super(KEY.getKey(), new AdvancementDisplay(Material.RAW_IRON, "Zbieracz 3", AdvancementFrameType.TASK, true, true, 3f, 0f , "Zbierz 10 sztuk surowego żelaza."), parent, 10);
